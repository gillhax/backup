...
public class UserResource {
   ...
   public ResponseEntity getAllUsers(@ApiParam Pageable pageable) throws URISyntaxException {
      ...
      List managedUserVMs = (List)page.getContent().stream().map(ManagedUserVM::<init>).collect(Collectors.toList());
   ...
   public ResponseEntity getUser(@PathVariable String login) {
      ...
      return (ResponseEntity)this.userService.getUserWithAuthoritiesByLogin(login).map(ManagedUserVM::<init>).map((managedUserVM) -> {
